...
class db
{
  ...
  // sqlを実行するラッパー関数
  public static function prepareAndExecute(string $sql, array $params = null, string $message = null, bool $isUpdate = false, bool $isDelete = false)
  {
  ...
  public static function deleteUserDB(int $id)
  {
    ...
    return db::prepareAndExecute($sql, $params, $message, false, true);
  }
